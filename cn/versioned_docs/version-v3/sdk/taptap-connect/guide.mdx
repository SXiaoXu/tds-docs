...
请先参考 [TapTap 登录](/v3/sdk/taptap-login/guide/start/#sdk-获取) 和 [内嵌动态](/v3/sdk/embedded-moments/guide/##sdk-获取)完成 SDK 获取，然后在此基础上可以通过 [下载](/v3/tap-download) 获得 TapSDK，添加 `TapConnect` 模块：
