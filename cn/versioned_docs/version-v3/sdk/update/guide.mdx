...
1. 在 [**下载页**](/v3/tap-download) 找到 **TapSDK Unity** 下载地址，分别下载 `TapSDK-UnityPackage.zip` 。
...
在 [下载页](/v3/tap-download) 获得 TapSDK，添加 `TapUpdate` 和 `TapCommon` 模块。
...
* 下载 [TapSDK UE4](/v3/tap-download)，TapSDK-UE4-xxx.zip 解压后将 `TapUpdate`、`TapCommon` 文件夹 Copy 到项目的 `Plugins` 目录中
* 重启 Unreal Editor
