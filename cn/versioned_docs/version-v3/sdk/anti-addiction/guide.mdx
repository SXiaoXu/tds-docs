...
可以在 [下载页](/v3/tap-download) 获得 TapSDK，引入防沉迷模块。
...
* 下载 [TapSDK UE4](/v3/tap-download)，TapSDK-UE4-xxx.zip 解压后将 `AntiAddiction`、`TapCommon`、`TapLogin`、`TapBootstrap(可选)` 文件夹 Copy 到项目的 `Plugins` 目录中
* 重启 Unreal Editor
