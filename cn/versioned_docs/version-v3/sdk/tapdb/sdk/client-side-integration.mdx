...
请先[下载](/v3/tap-download) TapSDK，并添加相关依赖。
...
* 下载 [TapSDK UE4](/v3/tap-download)，TapSDK-UE4-xxx.zip 解压后将 `TapDB`、`TapCommon` 文件夹 Copy 到项目的 `Plugins` 目录中
* 重启 Unreal Editor
...
* 在 [下载页](/v3/tap-download) 找到 TapSDK Unity 下载地址，下载 TapSDK-UnityPackage.zip 然后解压，导入其中的 `TapTap_Common`，`TapTap_TapDB`模块。
