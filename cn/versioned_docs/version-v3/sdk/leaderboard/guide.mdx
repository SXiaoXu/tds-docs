...
1. 在 [下载页](/v3/tap-download) 找到 **LeanCloud C# SDK** 下载地址，下载 `LeanCloud-SDK-Realtime-Unity.zip`。
...
* 下载 [TapSDK UE4](/v3/tap-download)，TapSDK-UE4-xxx.zip 解压后将 `LeanCloud`  文件夹 Copy 到项目的 `Plugins` 目录中
* 重启 Unreal Editor
